@section('styles')
    <link href="{{ url('/css/popup/black-payments.css') }}" rel="stylesheet">
@endsection
                                ...
                                <div class="popup-apartment-right">
                                    <ul class="popup-apartment-payment">
                                        ...
                                        @elseif(empty($residential))
                                            <li v-if="typeof residentials[payments.residential_index].installment.percent != 'undefined'">
                                                <i style="background-image: url({{ url('/img/apartment/installment.png') }})"></i><span>Рассрочка @{{ residentials[payments.residential_index].installment.percent || 0 }}% годовых</span>
                                            </li>
                                            <li v-else>
                                                <i style="background-image: url({{ url('/img/apartment/installment.png') }})"></i><span>Рассрочка на выгодных условиях</span>
                                            </li>
                                        @endif
                                        ...
                                        @elseif(empty($residential))
                                            <li v-if="typeof residentials[payments.residential_index].trade_in != 'undefined'">
                                                <i style="background-image: url({{ url('/img/apartment/trade-in.png') }})"></i><span>TRADE-in без переплат</span>
                                            </li>
                                        @endif
                                        ...
                                        @elseif(empty($residential))
                                            <li v-if="typeof residentials[payments.residential_index].mortgage_w_i_f != 'undefined'">
                                                <i style="background-image: url({{ url('/img/apartment/down-payment.png') }})"></i><span>Ипотека без первоначального взноса</span>
                                            </li>
                                        @endif
                                    </ul>
