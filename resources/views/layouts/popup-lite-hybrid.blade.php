@section('styles')
    <link href="{{ url('/css/popup/lite-hybrid.css') }}" rel="stylesheet">
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="popup-apartment-right">
                                    ...
                                    <div class="popup-apartment-payment">
                                        @if(!empty($residential))
                                            <div class="popup-apartment-payment-item">
                                                ...
                                                <img src="/img/apartment/check-mark.png"><span>Ипотека на выгодных условиях</span>
                                            </div>
                                        ...
                                        @if(!empty($residential->mortgageWIF))
                                            <div class="popup-apartment-payment-item">
                                                ...
                                                <img src="/img/apartment/check-mark.png"><span>Ипотека с минимальным первоначальным взносом</span>
                                            </div>
                                        @elseif(empty($residential))
                                        ...
                                        @elseif(empty($residential))
                                            <div class="popup-apartment-payment-item" v-if="residentials[payments.residential_index].installment && residentials[payments.residential_index].installment.percent">
                                                <img src="/img/apartment/check-mark.png"><span>Рассрочка @{{ residentials[payments.residential_index].installment.percent }}% годовых</span>
                                            </div>
                                    ...
                                    {{-- @if(getUrlPathFirstPart() !== 'sankt-peterburg')
                                    <div class="popup-main-phone"><a class="main-phone" href="tel:+73833884896">Узнать актуальную цену</a></div>
                                    <div class="popup-main-phone"> <a class="main-phone" href="tel:+70000000000" > </a></div> 
                                    @endif --}}

                                    {{-- <div class="popup-apartment-cta-form"> --}}
                                     @if(getUrlPathFirstPart() == 'sankt-peterburg')
                                        {{-- for mobile --}}
                                        <div class="new-info-wrapper-m hidden-lg">
                                            <div class="text-button-wrapper">
                                                <div class="text-info-m">Актуальная цена предоставляется по запроcу в отделе продаж</div>
                                                {!! SITE_CONTACTS[getUrlPathFirstPart()]['phone'] !!}
                                                <div class="button-phone-m popup-main-phone"><a class="main-phone text-button-popup main-phone-new-popup" href="tel:+73833884896">Узнать актуальную цену</a></div>
                                        
                                            </div>
                                        </div>

                                        {{-- for desctop --}}
                                        <div class="popup-apartment-cta-form hidden-sm hidden-md hidden-xs">
                                            <div class="new-info-wrapper">
                                                <div class="wrapper-image">  
                                                <div class="green-circle"></div>
                                                        <img class="image-face" src="/img/girl-origin.png">
                                                    
                                                </div>
                                                <div class="right-info-wrapper">
                                                    <div class="about-text-wrapper">
                                                        <div class="title-text-about-popup">актуальная цена</div>
                                                        <div class="text-info-popup">предоставляется по запросу в отделе продаж</div>
                                                    </div>
                                                    <div class="phone-wrapper">
                                                             <div class="number-phone-popup popup-main-phone">{!! SITE_CONTACTS[getUrlPathFirstPart()]['phone'] !!}</span> </div>
                                                        {{-- <div class="number-phone-popup popup-main-phone"><span class="main-phone main-phone-new-popup" href="tel:+73833884896">+7 (000) 000-00-00</span> </div> --}}
                                                        <div class="text-under-phone-popup">телефон отдела продаж</div>
                                                    </div>
                                                </div>
                                        </div>
                                    ...
                                    <br class="hidden-sm hidden-md hidden-xs"><br  class="hidden-sm hidden-xs">
                                {{-- <div class="popup-apartment-cta-form"> --}}
                                        ...
                                        <div class="popup-apartment-form">
                                            <div class="row" v-if="!requestSend">
                                                ...
                                                <div class="col-xs-12 oferta"><br>
                                                    Нажимая на кнопку "Узнать цену", Вы соглашаетесь с <a href="/oferta.pdf" target="_blank">политикой конфиденциальности</a>
                                                </div>
                                            </div>
