@section('styles')
    <link href="{{ url('/css/popup/aggressor.css') }}" rel="stylesheet">
@endsection
                                    ...
                                    <div class="popup-apartment-cta-form">
                                        ...
                                        <div class="popup-apartment-form">
                                            <div class="row" v-if="!requestSend">
                                                ...
                                                <div class="col-xs-6">
                                                    <button type="button" @click.prevent="storeRequest('{{ getUrlPathFirstPart() }}')">Заказать звонок</button>
                                                </div>
                                                <div class="col-xs-12">
                                        ...
                                        <div class="popup-apartment-phone">Или по телефону: <b>{!! SITE_CONTACTS[getUrlPathFirstPart()]['phone'] !!}</b></div>
                                    </div>
                                </div>
                            </div>
                        </div>
