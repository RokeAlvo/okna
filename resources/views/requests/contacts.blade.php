            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form id="contact-form" class="custom-form" action="/contacts" method="post">
                        <input type="hidden" name="_csrf-frontend" value="OXlISHhaMWNIGCMjOgtAJgAUOx8OOGcTUSMODkgcZxldLD0/LyxmPA==">
                        <div class="row">
                            <div class="col-xs-6">
                        ...
                        <div class="form-group field-contactform-comment required">
                            <textarea id="contactform-comment" class="form-control" name="ContactForm[comment]" rows="6" placeholder="Ваше сообщение"
