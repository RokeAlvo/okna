                ...
                <div class="mortgage-info-block">
                    ...
                    <div class="mortgage-description">
                        ...
                        <form id="form-request" class="custom-form" action="" method="post">
                            ...
                            <input type="hidden" id="actionform-form_name" class="form-control" name="type" value="3">

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group field-actionform-user_phone required">

                                        <input type="text" id="actionform-user_phone" class="form-control" name="client_phone"
                                               placeholder="Ваш номер телефона" aria-required="true" data-plugin-inputmask="inputmask_0ffde171">

                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-block btn-lg btn-yellow btn-custom-lg btn-round"><i
                                                class="fa fa-mobile fa-lg mr15" aria-hidden="true"></i>Заявка на ипотеку
                                    </button>
                                </div>
                            </div>
