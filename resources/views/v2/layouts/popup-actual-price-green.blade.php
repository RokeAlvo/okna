@section('styles')
    <link href="{{ url('/v2/css/popup/actual-price-green.css') }}" rel="stylesheet">
@endsection
...
<div v-cloak>  <!--style="display: none;"-->
    <transition id="apartment-popup-transition" appear name="fade" v-cloak> <!-- -->
        <div class="popup-wrapper" v-if="~selectedLayoutIndex" data-popup-window="apartment" id="{{ $popupType }}">
            <div class="close-popup-m" @click="closePopup"><img src="/img/sign-x.png" class="sign-x"><div> закрыть</div></div>
                    ...
                    <div class="plan-info-cont-wrapper">
                        ...
                        <div id="popup-apatrament" class="info-popup-wrapper">
                            ...
                            <div class="info-popup-title accordion">
                                <span class="info-popup-title-full info-popup-title-dev">О ЖК &laquo;@{{ selectedLayoutResidential.title }}&raquo;</span>
                                <span class="info-popup-title-short info-popup-title-dev">О ЖК &laquo;@{{ selectedLayoutResidential.title }}&raquo;</span>
                            </div>
                            @else
                            <div class="info-popup-title accordion">
                            ...
                            <div class="table-wrapper panel">
                                <div class="info-popup-wrapper-list">
                                    ...
                                    @if(isset($developer))
                                    <div class="info-popup-wrapper-list-item">
                                        <div class="data-popup">Адрес</div>
                                        <div class="data-popup-base">@{{ selectedLayoutResidential.address }}</div>
                                    </div>
                                    <div v-if="selectedLayoutResidential.metro_station" class="info-popup-wrapper-list-item">
                                        <div class="data-popup">Станция метро</div>
                                        <div class="data-popup-base">@{{ selectedLayoutResidential.metro_station.name }}</div>
                                    </div>
                                    @endif
                                ...
                                @if(isset($developer))
                                <div class="more-info-popup-wrapper">
                                    <div class="more-info-button-text">Подробнее о жилом комплексе</div>
                                    <a class="more-info-button" :href="selectedLayoutResidential.routeShow" target="_blank">Подробнее</a>
                                </div>
                                <a class="more-info-button-mob" :href="selectedLayoutResidential.routeShow" target="_blank">Подробнее о ЖК</a>
                                @endif
                            </div>
                        ...
                        <div class="price-number-wrapper">
                            <div class="popup-phone-box">
                                <div class="popup-text-info"><img src="/img/white-rub.png">
                                    <div class="popup-text-title-rub">Узнайте актуальную цену прямо сейчас</div>
                                </div>
                            ...
                            <div class="call-self d-none d-md-block">
                                Или узнавайте цену по телефону: {!! SITE_CONTACTS[getUrlPathFirstPart()]['phone'] !!}
                            </div>
                        </div>
                    </div>
