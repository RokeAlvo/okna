...
<div v-cloak>
        ...
        <div class="popup-wrapper" v-if="~selectedLayoutIndex" data-popup-window="apartment" id="{{ $popupType }}">
            ...
            <div class="popup popup-right" @click.self="closePopup">
                <div class="popup-body">
                    ...
                    <!-- <div class="sale-popup-wrapper">
                        <div class="sale-icon sale-text--hiden" onclick="showSaleText(this)"></div>
                        <div class="sale-text ">Подробности уточняйте в отделе продаж: <div>+7 (383) 456-87-46</div>
                        </div>
                    </div> -->
    ...
    @include('v2.layouts.modules.loupe')
                    ...
                    <div class="plan-info-cont-wrapper">
                        ...
                        <div class="price-number-wrapper" v-if="!requestSend">
                            <div class="popup-phone-box">
                                ...
                                <div class="popup-text-under">Оставьте свой номер телефона и получите ответы на все интересующие вас вопросы</div>
                            </div>
                        ...
                        <div class="welcome-wrapper" v-else>
                            ...
                            <div class="popup-text-welcome-under">Наш менеджер свяжется с вами в течение пяти минут (в рабочее время), чтобы согласовать время
                                экскурсии
                            </div>
