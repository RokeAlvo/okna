@section('styles')
    <link href="{{ url('/v2/css/popup/actual-price-white.css') }}" rel="stylesheet">
@endsection

<div {{--:class="[canShowPopup ? 'visible-block' : '']" style="display: none;"--}} v-cloak>  <!--style="display: none;"-->
                    ...
                    <div class="plan-info-cont-wrapper">
                        ...
                        <div class="price-number-wrapper">
                            <div class="popup-phone-box">
                                <div class="popup-text-info"><img src="/img/green-rub.png">
                            ...
                            <div class="call-self d-none d-md-block">
                                Или узнавайте актуальную цену по телефону :&#8195; {!! SITE_CONTACTS[getUrlPathFirstPart()]['phone'] !!}
                            </div>
                        </div>
                    </div>
