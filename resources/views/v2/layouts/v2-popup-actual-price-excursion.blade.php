                        ...
                        <div class="price-number-wrapper" v-if="!requestSend">
                            <div class="popup-phone-box">
                                <div class="popup-text-info"><img src="/img/white-rub.png">
                                    <div class="popup-text-title-rub">Хотите посмотреть эту квартиру?</div>
                                </div>
                                <div class="popup-text-under">Запишитесь на экскурсию и оцените всё вживую <span>(только по предварительной записи)</span></div>
                            </div>
