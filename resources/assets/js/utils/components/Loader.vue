<template>
  <div class="banter-loader" :class="{'banter-loader--absolute': !isNotAbsolute, 'theme' : true}">
  <!-- <div class="banter-loader--absolute"> -->
...
$animTime: 4s;
.banter-loader {
  /*<!--margin-left: $contSize/-2 + 245px;-->*/
  &.banter-loader--absolute {
    // margin-left: 90px;
  }
}
/*<!--@media (max-width: 1400px){-->*/
/*<!--.banter-loader{-->*/
/*<!--margin-left: $contSize/-2 + 30px;-->*/
/*<!--}-->*/
/*<!--}-->*/
.banter-loader {
  &.banter-loader--absolute {
