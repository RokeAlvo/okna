  ...
  <div class="flowers-wrapper">
    ...
    <div class="flowers-top">
      ...
      <ul class="flowers-list">
        <li class="flowers-list__item">Бесплатное оформление без визита в банк</li>
        <li class="flowers-list__item">Получение ипотечного решения за 2 дня</li>
    ...
    <div class="flowers-bottom">
      <div class="credit-text">Что делать, если нет первоначального взноса?</div>

      <div
        class="request-text"
      >Оставьте заявку и наш специалист расскажет о способах решения этой ситуации</div>
      ...
      <span class="ok__btn-container" v-on:click.capture="validatePhone">
