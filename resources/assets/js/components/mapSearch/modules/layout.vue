	...
	>
		<div class="layout__header">
			<div v-if="header" class="layout-header-content">
				<div v-if="price" class="layout-header-title">от {{priceLocal}} ₽</div>
...
export default {
  ...
  methods:{
	...
	computed: {
		...
		background(){
			let background = {
				'background' : 'linear-gradient(202.39deg, rgba(45, 48, 56, 0) 8.25%, rgba(39, 45, 57, 0.8) 85%) 0% 0%, url('+this.img+') center no-repeat',
