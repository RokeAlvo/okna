<template>
  <div class="selection">
    <modal-j-k/>
    <div v-bind:class="[isFavorites ? 'header--sticky' : 'header--none']">
      <div class="logo"></div>
      <div class="favorites">
        <div class="star">
          <Star/>
    ...
    <div class="selection-wrapper">
      <div class="welcome">
        ...
        <div class="welcome__select">Мы подобрали для вас 18 квартир в 4 комплексах</div>
      </div>
      <div class="scrolling-wrapper" v-bind:class="{'scrolling-wrapper--sticky': isFavorites}">
        <div class="item">
      ...
      <div class="jk">
        <div class="jk__img">
          <div class="is-gorizontal">
            <button class="about-jk" @click="$modal.show('example-adaptive');">оs комплексе</button>
          </div>
          <div class="jk-name">
            ГринАрт
