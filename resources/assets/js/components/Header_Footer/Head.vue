<template>
  <header>
    <div class="header-wrapper">
      ...
      <div class="nav">
        <label @click="close" for="nav-toggle" class="nav-toggle"></label>
        ...
        <div class="header-phone phone menu-phone">
          <a class="change-phone header-phone_number phone_number">+7 (383) 388-48-96</a>
        </div>
      </div>
...
export default {
  ...
  methods:{
    close(){
      setTimeout(()=>document.querySelector('.nav').classList.remove('nav-z'),200);
    }
  }
};
</script>
