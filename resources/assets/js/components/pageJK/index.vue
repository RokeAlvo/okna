<template >
  <div class="new-jk">
    ...
    <transition name="fade-left-menu">
      <div v-show="showLeftMenu" class="left-menu__wrapper">
        <div class="left-menu__wrappers">
          <div class="close-left-menu" v-on:click="closeLeftMenu"></div>
          <div class="left-menu">
            ...
            <ul class="left-menu__list">
              <li class="left-menu__list__item">
                <a href="#photos" v-on:click="closeLeftMenu">Фотографии</a>
              </li>
              <li class="left-menu__list__item">
                <a href="#about-jk" v-on:click="closeLeftMenu">О комплексе</a>
              </li>
              <li class="left-menu__list__item">
                <a href="#apartments" v-on:click="closeLeftMenu">Квартиры</a>
              </li>

              <li class="left-menu__list__item">
                <a href="#location" v-on:click="closeLeftMenu">Расположение</a>
              </li>
              <li
                v-if="isDiscount"
    ...
    <section id="photos" class="slider-jk">
      ...
      <transition name="fade-popup">
        <div v-show="showDiscount" class="discount-popup--fixed">
          <div class="close-popup" v-on:click="closeDiscount"></div>
      ...
      <swiper v-if="this.$store.state.currentJK" :options="swiperOption">
        ...
        <swiper-slide
          ...
          :key="slider.id"
        >
          <div class="slide-img" v-lazy:background-image="slider.main"></div>
        </swiper-slide>
    ...
    <section id="about-jk" class="jk-info">
      ...
      <ul class="desc-list">
        ...
        <li class="desc-list__item desc-list__item--deadline">
          ...
          <div class="item-text" v-if="this.$store.state.currentJK">
    ...
    <section class="popups-list">
      <keep-alive>
        <ipoteka-alone
          ...
          "
        />
        <Ipoteka v-else :popupsArr="popupsArr" />
      </keep-alive>
      <PayPopup
    ...
    <section id="apartments" class="apartments">
      ...
      >
        <div class="apartments-heandler">
          ...
          <span class="apartments-heandler--metr" v-else>
      ...
      <div v-if="this.$store.state.dataStateJK" class="apartments-filter">
        ...
        >
          <span class="ranges-m" v-if="min_area === max_area"
            >{{ min_area }} м<sup>2</sup></span
          >
          <span class="ranges-m" v-else
    ...
    <section id="discount" v-if="isDiscount" class="discount">
    ...
    <section id="location" class="map">
      ...
      <div id="map-comp" class="map__jk" style="width:100%;">
        ...
        <div class="jk-map__zoom-control-wrapper">
          <div @click="zoom(+1)" class="jk-map__zoom-control zoom-plus">
            <img src="/images/map-search/plus.svg" />
          </div>
          <div @click="zoom(-1)" class="jk-map__zoom-control zoom-minus">
...
export default {
  ...
  methods: {
    ...
    loadingMap() {
      let heightOfWindow = document.documentElement.scrollTop;

      let tt = document.getElementsByClassName("apartments");
    ...
    phoneChange() {
      setTimeout(function() {
        ...
        let inPhoneText = document.getElementsByClassName("change-phone--text");
  ...
  computed: {
    ...
    filterApart() {
      ...
      if (this.$store.state.currentJK) {
        let ars = this.$store.state.currentJK.ranges_formatted.forEach(
          element => {
    ...
    isDiscount() {
      if (this.$store.state.dataStateJK.discount_title) {
        let discountTitle = this.$store.state.currentJK.discount_title;
        let dateNow = new Date();
        let discountStart = this.$store.state.currentJK.discount_start
          ? new Date(this.$store.state.currentJK.discount_start)
          : null;
        let discountFinish = this.$store.state.currentJK.discount_finish
    ...
    discountFinish() {
      if (this.$store.state.dataStateJK.discount_title) {
        ...
        let date = new Date(),
          y = date.getFullYear(),
          m = date.getMonth();
        let discoutTo = this.$store.state.currentJK.discount_finish
          ? new Date(
  ...
  created() {
    ...
    if (sessionStorage.getItem("test")) {
      ...
      let testConst = Math.floor(Math.random() * 2);
