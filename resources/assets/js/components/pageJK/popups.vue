<template>
  <div class="popups-wrapper">
    <div
      class="popups-item"
      v-bind:class="'popups-item--'+ popup.name"
      v-for="popup in popupsArr"
      :key="popup.name"
    >
      <div class="popups-item-overlay" v-bind:class="'popups-item-overlay--'+ popup.name">
        <div class="popup-title">{{popup.title}}</div>
        <div
          class="button__detail"
          v-bind:class="'button__detail--'+ popup.name"
          v-bind:id="popup.name"
          v-on:click="showPopup(popup)"
        >Подробнее</div>
      </div>
    </div>
    <transition name="fade">
      ...
      >
        <div class="popup--fixed" v-bind:class="'popup--fixed--'+ this.name">
          <!-- v-click-outside="test" -->
          <div class="close-popup" v-on:click="closePop">
