<template>
  <div  v-on:click.self="closeRequestCall" class="fixed-overlay--off">
    <div v-if="!isSend" class="request-popup--fixed">
      <div class="close-popup" v-on:click="closeRequestCall"></div>
      ...
      <div class="jk-btn--green" v-on:click="validatePhone()">
