<template>
  <div class="popups-wrapper">
    <div
      class="popups-item"
      v-bind:class="'popups-item--' + this.popupsArr[0].name"
    >
      <div
        ...
        "
        v-bind:class="'popups-item-overlay--' + this.popupsArr[0].name"
      >
        <div class="popup-title">{{ this.popupsArr[0].title }}</div>
        <div
          class="button__detail"
          v-bind:class="'button__detail--' + this.popupsArr[0].name"
          v-bind:id="this.popupsArr[0].name"
          v-on:click="showPopup(popupsArr[0])"
        >
          Подробнее
        </div>
      </div>
