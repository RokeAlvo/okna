new Vue({
    ...
    updated: function () {
        if ($('.main-phone').length) {
            document.querySelector('.popup-apartment-phone .main-phone').innerHTML = document.querySelector('.main-phone').innerHTML;
            // let phone = document.getElementsByClassName('change-phone')
            // for(let i=0; i<phone.length; i++){
            //     console.log('wwewewe');
            //     phone[i].innerHTML = document.querySelector('.main-phone').innerHTML;
            // }

            // document.querySelector('.popup-wrapper .main-phone').innerHTML = document.querySelector('.main-phone').innerHTML;
        }
    },
    computed: {
